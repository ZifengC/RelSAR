    ...
    for batch_idx, batch in enumerate(loader, start=1):
        ...
        for i in range(batch_size):
            ...
            row = {
                ...
                'intent_bias_scale': float(model.intent_bias_scale),
                'state_temp_scale': float(model.state_temp_scale),
                'state_temp_max': float(model.state_temp_max),
                ...
                'global_state_uncertainty_mean': scalar_regularization.get('state_uncertainty_mean', float('nan')),
                'global_belief_confidence_mean': scalar_regularization.get('belief_confidence_mean', float('nan')),
                'global_state_temp_mean': scalar_regularization.get('state_temp_mean', float('nan')),
                ...
                'rec_state_uncertainty_mean': scalar_regularization.get('state_uncertainty_mean', float('nan')),
                'rec_belief_confidence_mean': scalar_regularization.get('belief_confidence_mean', float('nan')),
                'rec_state_temp_mean': scalar_regularization.get('state_temp_mean', float('nan')),
                ...
                'src_state_uncertainty_mean': scalar_regularization.get('state_uncertainty_mean', float('nan')),
                'src_belief_confidence_mean': scalar_regularization.get('belief_confidence_mean', float('nan')),
                'src_state_temp_mean': scalar_regularization.get('state_temp_mean', float('nan')),
                ...
                'batch_state_uncertainty_mean': scalar_regularization.get('state_uncertainty_mean', float('nan')),
                ...
                'batch_state_temp_mean': scalar_regularization.get('state_temp_mean', float('nan')),
